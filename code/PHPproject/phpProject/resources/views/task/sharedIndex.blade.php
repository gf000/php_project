...
<a href="/list/sharedList"><i class="layui-icon layui-icon-return" style="font-size: 30px; color: #009688;font-weight:800;position:relative;top:50px;left:50px;"></i></a>
...
<div class="layui-tab layui-tab-card" style="margin:100px;margin-top:50px;height:1000px;">
  ...
  <div class="layui-tab-content" style="height: 100px;">
    ...
    <div class="layui-tab-item layui-show">
        ...
        @endif
        @if($share->edit_right==0)
        <button type="button" class="layui-btn layui-btn-radius layui-btn-disabled" style="width:150px;margin-right:100px" >
            <i class="layui-icon">&#xe608;</i> ADD
        </button>
        @endif
        </div>
    ...
    <div class="layui-tab-item" id="uncomplete">
        <div style="margin-top:50px;margin-left:300px">
            ...
            @endif
            @if($share->complete_right==0)
            <button type="button" class="layui-btn layui-btn-warm layui-btn-radius layui-btn-disabled" style="width:150px;margin-right:100px " >
                <i class="layui-icon">&#xe605;</i> Check Off All
            </button>
            @endif
    ...
    <div class="layui-tab-item" id="complete">
        <div class="layui-tab-item layui-show">
            ...
            @endif
            @if($share->edit_right==0)
            <button type="button" class="layui-btn layui-btn-danger layui-btn-radius layui-btn-disabled" style="width:150px;" >
                <i class="layui-icon">&#xe640;</i> Delete All
            </button>
            @endif
        </div>
